...
import { n as logError, t as logDebug } from "./logger-BGSZ8m40.js";
...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./order-D6g7Gz1k.js";
import { d as updateSessionStore, i as loadSessionStore, o as readSessionUpdatedAt } from "./store-Cs-WFRag.js";
import { l as resolveStorePath } from "./paths-sf4ch2Nw.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-jTYTnisD.js";
import { c as getAgentScopedMediaLocalRoots, t as loadWebMedia } from "./web-media-Bhty-vWo.js";
...
import { m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts } from "./reply-payload-DFX4yBqp.js";
import { t as withTimeout } from "./with-timeout-DwaV3FdV.js";
import { i as formatDurationSeconds } from "./format-duration-DK9En-14.js";
import "./runtime-env-Cv7gkvxy.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-Dvt-i5un.js";
import { n as chunkItems } from "./text-runtime-DefrZir4.js";
import { t as summarizeStringEntries } from "./string-sample-HGu8ZCxx.js";
import { c as getExecApprovalApproverDmNoticeText, n as buildExecApprovalActionDescriptors } from "./exec-approval-reply-DnX55cbJ.js";
import { i as resolveAgentRoute } from "./resolve-route-BmwWWdj5.js";
import { n as wrapFetchWithAbortSignal } from "./fetch-CSTQoM3K.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-Cp52YF19.js";
import { c as listChatCommands, d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, h as resolveCommandArgChoices, m as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, v as serializeCommandArgs } from "./commands-registry-1mkLI72p.js";
import { g as formatThreadBindingDurationLabel } from "./thread-bindings-policy-e9gtR9L4.js";
import "./routing-plyUTpqn.js";
import { t as finalizeInboundContext } from "./inbound-context-DRnxt8Yi.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-C6ShMImc.js";
...
import { t as buildPairingReply } from "./pairing-messages-BRt4gave.js";
import { i as resolveStoredModelOverride } from "./model-selection-BdnCicBy.js";
import { a as patchAllowlistUsersInConfigEntries, n as buildAllowlistResolutionSummary, o as summarizeMapping, r as canonicalizeAllowlistWithResolvedIds, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-_DnqafJt.js";
import { n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-DPpYfcGE.js";
import { o as resolveExecApprovalCommandDisplay, t as doesApprovalRequestMatchChannelAccount } from "./exec-approval-session-target-kgcdF1mk.js";
import "./approval-runtime-ZxR-OQ2B.js";
import { a as matchesApprovalRequestFilters } from "./approval-renderers-Atzg1kLs.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-G0DZk90K.js";
import "./config-runtime-DmPX4R_k.js";
import { r as createReplyReferencePlanner } from "./reply-runtime-CZ-vIRHF.js";
...
import { t as security_runtime_exports } from "./security-runtime-CNenFcar.js";
import { t as createConnectedChannelStatusPatch } from "./gateway-runtime-DNdoy7RG.js";
...
import { t as createArmableStallWatchdog } from "./channel-lifecycle-DHnCXi4Q.js";
import "./fetch-runtime-CZKJbanv.js";
import "./state-paths-Bz2vOXnx.js";
import { t as normalizeDiscordToken } from "./token-SJUrDgiz.js";
import { c as resolveDiscordMaxLinesPerMessage, o as resolveDiscordAccount } from "./accounts-CKf6hS8T.js";
import { _ as formatDiscordUserTag, a as resolveDiscordAllowListMatch, d as resolveDiscordOwnerAccess, g as formatDiscordReactionEmoji, h as shouldEmitDiscordReactionNotification, i as normalizeDiscordSlug, l as resolveDiscordGuildEntry, m as resolveGroupDmAllow, n as isDiscordGroupAllowedByPolicy, r as normalizeDiscordAllowList, s as resolveDiscordChannelConfigWithFallback, u as resolveDiscordMemberAccessState } from "./allow-list-B67a48Gn.js";
import { i as getDiscordExecApprovalApprovers, n as createDiscordNativeApprovalAdapter, t as DiscordUiContainer } from "./ui-Cfagkhqh.js";
import { Ct as ChannelType$2, D as resolveDiscordModalEntry, E as resolveDiscordComponentEntry, S as parseDiscordModalCustomIdForCarbon, St as ButtonStyle$1, Tt as Routes$1, _ as createDiscordFormModal, _t as createDiscordClient, b as parseDiscordComponentCustomIdForCarbon, bt as chunkDiscordTextWithMode, dt as stripUndefinedFields, o as editDiscordComponentMessage, v as formatDiscordComponentEventText, x as parseDiscordModalCustomId, xt as ApplicationCommandOptionType$1, y as parseDiscordComponentCustomId } from "./send-B-eYcn1M.js";
import { t as formatMention } from "./mentions-B6pmN3gh.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-kLXcN2ON.js";
import { a as isThreadArchived } from "./thread-bindings.discord-api-DUeFqgIS.js";
import { c as setPresence, i as unregisterGateway, r as registerGateway } from "./gateway-registry-BlMXa5iV.js";
import { t as fetchDiscordApplicationId } from "./probe-DzZixnaA.js";
import { c as normalizeDiscordListenerTimeoutMs, l as runDiscordTaskWithTimeout } from "./timeouts-3qrofOhM.js";
import { C as resolveDiscordChannelInfo, a as handleDiscordDmCommandDecision, c as deliverDiscordReply, g as resolveDiscordThreadParentInfo, i as resolveDiscordEffectiveRoute, l as buildDirectLabel, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, s as sendTyping, u as buildGuildLabel, y as resolveDiscordSenderIdentity } from "./route-resolution-CHjImv0E.js";
import { t as authorizeDiscordVoiceIngress } from "./access-SBEaJ_Zy.js";
import { n as buildDiscordInboundAccessContext, t as buildDiscordGroupSystemPrompt } from "./inbound-context-D96QB9Ud.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-DV8vOOt-.js";
...
var ExecApprovalActionRow = class extends Row {
	constructor(approvalId) {
		super([...buildExecApprovalActionDescriptors({ approvalCommandId: approvalId }).map((descriptor) => new ExecApprovalActionButton({
			approvalId,
			descriptor
		}))]);
	}
...
var DiscordExecApprovalHandler = class {
	...
	shouldHandle(request) {
		...
		if (this.getApprovers().length === 0) return false;
	...
	async deliverRequested(request) {
		...
		const body = stripUndefinedFields(serializePayload(buildExecApprovalPayload(isPluginApprovalRequest(request) ? createPluginApprovalRequestContainer({
			request,
			cfg: this.opts.cfg,
			accountId: this.opts.accountId,
			actionRow
		...
		const approvalKind = isPluginApprovalRequest(request) ? "plugin" : "exec";
		...
		return await deliverApprovalRequestViaChannelNativePlan({
			...
			deliverTarget: async ({ plannedTarget, preparedTarget }) => {
				const message = await discordRequest(() => rest.post(Routes$1.channelMessages(preparedTarget.discordChannelId), { body }), plannedTarget.surface === "origin" ? "send-approval-channel" : "send-approval");
				if (!message?.id) {
...
//#endregion
//#region extensions/discord/src/monitor/provider.lifecycle.reconnect.ts
const DISCORD_GATEWAY_READY_TIMEOUT_MS = 15e3;
const DISCORD_GATEWAY_READY_POLL_MS = 250;
const DISCORD_GATEWAY_DISCONNECT_DRAIN_TIMEOUT_MS = 5e3;
const DISCORD_GATEWAY_FORCE_TERMINATE_CLOSE_TIMEOUT_MS = 1e3;
const DISCORD_GATEWAY_HELLO_TIMEOUT_MS = 3e4;
const DISCORD_GATEWAY_HELLO_CONNECTED_POLL_MS = 250;
const DISCORD_GATEWAY_MAX_CONSECUTIVE_HELLO_STALLS = 3;
const DISCORD_GATEWAY_RECONNECT_STALL_TIMEOUT_MS = 5 * 6e4;
...
function createDiscordGatewayReconnectController(params) {
	...
	const reconnectStallWatchdog = createArmableStallWatchdog({
		...
		onTimeout: () => {
			...
			const at = Date.now();
			const error = /* @__PURE__ */ new Error(`discord reconnect watchdog timeout after ${DISCORD_GATEWAY_RECONNECT_STALL_TIMEOUT_MS}ms`);
			params.pushStatus({
				connected: false,
				lastEventAt: at,
				lastDisconnect: {
			...
			params.runtime.error?.(danger(`discord: reconnect watchdog timeout after ${DISCORD_GATEWAY_RECONNECT_STALL_TIMEOUT_MS}ms; force-stopping monitor task`));
	...
	const disconnectGatewaySocketWithoutAutoReconnect = async () => {
		...
		for (const listener of socket.listeners("close")) socket.removeListener("close", listener);
		...
		await new Promise((resolve, reject) => {
			...
			drainTimeout = setTimeout(() => {
				...
				params.runtime.error?.(danger(`discord: gateway socket did not close within ${DISCORD_GATEWAY_DISCONNECT_DRAIN_TIMEOUT_MS}ms before reconnect; attempting forced terminate before giving up`));
				...
				if (!terminateStarted) {
					params.runtime.error?.(danger(`discord: gateway socket did not expose a working terminate() after ${DISCORD_GATEWAY_DISCONNECT_DRAIN_TIMEOUT_MS}ms; force-stopping instead of opening a parallel socket`));
					rejectClose(/* @__PURE__ */ new Error(`discord gateway socket did not close within ${DISCORD_GATEWAY_DISCONNECT_DRAIN_TIMEOUT_MS}ms before reconnect`));
					return;
				}
				terminateCloseTimeout = setTimeout(() => {
					...
					params.runtime.error?.(danger(`discord: gateway socket did not close ${DISCORD_GATEWAY_FORCE_TERMINATE_CLOSE_TIMEOUT_MS}ms after forced terminate; force-stopping instead of opening a parallel socket`));
					rejectClose(/* @__PURE__ */ new Error(`discord gateway socket did not close within ${DISCORD_GATEWAY_DISCONNECT_DRAIN_TIMEOUT_MS}ms before reconnect`));
	...
	const reconnectGateway = async (reconnectParams) => {
		if (reconnectInFlight) return await reconnectInFlight;
		reconnectInFlight = (async () => {
			if (reconnectParams.forceFreshIdentify) clearResumeState();
			if (shouldStop()) return;
			await disconnectGatewaySocketWithoutAutoReconnect();
			if (shouldStop()) return;
			params.gateway?.connect(reconnectParams.resume);
		})().finally(() => {
			reconnectInFlight = void 0;
		});
	...
	const onGatewayDebug = (msg) => {
		...
		if (message.includes("WebSocket connection closed")) {
			if (params.gateway?.isConnected) resetHelloStallCounter();
		...
		if (sawConnected) pushConnectedStatus(at);
		...
		helloTimeoutId = setTimeout(() => {
			...
			(async () => {
				try {
					...
					const forceFreshIdentify = consecutiveHelloStalls >= DISCORD_GATEWAY_MAX_CONSECUTIVE_HELLO_STALLS;
					...
					params.runtime.log?.(danger(forceFreshIdentify ? `connection stalled: no HELLO within ${DISCORD_GATEWAY_HELLO_TIMEOUT_MS}ms (${consecutiveHelloStalls}/${DISCORD_GATEWAY_MAX_CONSECUTIVE_HELLO_STALLS}); forcing fresh identify` : `connection stalled: no HELLO within ${DISCORD_GATEWAY_HELLO_TIMEOUT_MS}ms (${consecutiveHelloStalls}/${DISCORD_GATEWAY_MAX_CONSECUTIVE_HELLO_STALLS}); retrying resume`));
					if (forceFreshIdentify) resetHelloStallCounter();
					if (shouldStop()) return;
					...
					params.runtime.error?.(danger(`discord: failed to restart stalled gateway socket: ${String(err)}`));
	...
	const ensureStartupReady = async () => {
		if (!params.gateway || params.gateway.isConnected || shouldStop()) {
			if (params.gateway?.isConnected && !shouldStop()) pushConnectedStatus(Date.now());
			return;
		}
...
async function runDiscordGatewayLifecycle(params) {
	...
	const drainPendingGatewayErrors = () => params.gatewaySupervisor.drainPending((event) => {
		...
		if (event.type === "disallowed-intents" || event.type === "reconnect-exhausted" && (lifecycleStopping || params.abortSignal?.aborted === true)) return "stop";
		throw event.err;
	});
	try {
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-VWcpvwtB.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-ZnSHNtQf.js");
