...
beta-manager → sessions_send(target="agent:main:coding-4", message="<task>")
...
- My config is at ~/.openclaw/agents/coding-4/openclaw.json
...
- **After reviewing code:** Document common issues and fixes

### API
```bash
GET  http://localhost:18850/search?q=testing+review
POST http://localhost:18850/notes {"title": "...", "folder": "code-patterns", "content": "...", "tags": ["type/code"], "agent": "coding-4"}
POST http://localhost:18850/daily-log?agent=coding-4
```
