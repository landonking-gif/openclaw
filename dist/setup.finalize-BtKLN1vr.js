...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-CLgvULWg.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-BWbT1YJU.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CXcGwK73.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-CG7Kdyxh.js";
import { t as listConfiguredWebSearchProviders } from "./runtime-DGz3G3vA.js";
...
import { t as runTui } from "./tui-B8g-Scff.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Jw6og5MV.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-CDKS3VUM.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CrYz4O5o.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CrYz4O5o.js");
