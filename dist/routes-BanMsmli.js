...
import { l as escapeRegExp, t as CONFIG_DIR, v as resolveUserPath } from "./utils-ozuUQtXc.js";
...
import { o as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-DTvsfd9L.js";
...
import { n as deriveDefaultBrowserCdpPortRange, r as deriveDefaultBrowserControlPort } from "./port-defaults-C8IN_R-g.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-BwkKDkHh.js";
import "./temp-path-BCOpIB5z.js";
import { a as ensureGatewayStartupAuth } from "./nodes.helpers-0R0u8G4g.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DsEjZQQU.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-DsEjZQQU.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-DsEjZQQU.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
...
//#endregion
export { deleteBridgeAuthForPort as $, resolveBrowserConfig as A, DEFAULT_UPLOAD_DIR as B, createBrowserRouteContext as C, readBrowserVersion as D, parseBrowserMajorVersion as E, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as F, DEFAULT_FILL_FIELD_TYPE as G, resolveStrictExistingPathsWithinRoot as H, ensureBrowserControlAuth as I, BrowserTabNotFoundError as J, normalizeBrowserFormField as K, resolveBrowserControlAuth as L, DEFAULT_AI_SNAPSHOT_MAX_CHARS as M, DEFAULT_BROWSER_EVALUATE_ENABLED as N, resolveGoogleChromeExecutableForPlatform as O, DEFAULT_OPENCLAW_BROWSER_COLOR as P, withBrowserNavigationPolicy as Q, withNoProxyForCdpUrl as R, stopBrowserRuntime as S, getChromeWebSocketUrl as T, matchBrowserUrlPattern as U, resolveExistingPathsWithinRoot as V, getBrowserProfileCapabilities as W, assertBrowserNavigationRedirectChainAllowed as X, assertBrowserNavigationAllowed as Y, assertBrowserNavigationResultAllowed as Z, getBrowserControlState as _, parseRoleRef as a, isDefaultBrowserPluginEnabled as b, appendCdpPath as c, normalizeCdpHttpBaseForJsonEndpoints as d, setBridgeAuthForPort as et, redactCdpUrl as f, createBrowserControlContext as g, createBrowserRouteDispatcher as h, getRoleSnapshotStats as i, resolveProfile as j, markPwAiLoaded as k, fetchJson as l, fetchBrowserJson as m, buildRoleSnapshotFromAiSnapshot as n, formatAriaSnapshot as o, withCdpSocket as p, normalizeBrowserFormFieldValue as q, buildRoleSnapshotFromAriaSnapshot as r, normalizeCdpWsUrl as s, registerBrowserRoutes as t, getHeadersWithAuth as u, startBrowserControlServiceFromConfig as v, movePathToTrash as w, createBrowserRuntimeState as x, stopBrowserControlService as y, DEFAULT_TRACE_DIR as z };
