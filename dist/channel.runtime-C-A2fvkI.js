...
import "./accounts-8UwUIFfY.js";
import "./runtime-api-CRaG6Icy.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-kWhmABZF.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BhsZu6Mh.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DQH9c6AJ.js");
