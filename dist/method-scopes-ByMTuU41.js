...
import { n as FILE_SECRET_REF_ID_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-CxEAy2bI.js";
...
import { a as isSecureWebSocketUrl, r as isLoopbackHost } from "./net-ufRGHFYT.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS } from "./message-channel-ChfElmW5.js";
import { a as signDevicePayload, i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-_spqNmz2.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-CNts70Sy.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-tzUjXbVe.js";
import { t as rawDataToString } from "./ws-B1jF4TGA.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-C9BIN5EJ.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-DRF8vdog.js";
import { n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-q4fdbbT7.js";
...
//#endregion
export { validateExecApprovalsNodeSetParams as $, validateWizardStartParams as $t, validateConfigPatchParams as A, validateSessionsMessagesSubscribeParams as At, validateCronRunsParams as B, validateSkillsStatusParams as Bt, validateChannelsStatusParams as C, validateSecretsResolveResult as Ct, validateChatSendParams as D, validateSessionsCreateParams as Dt, validateChatInjectParams as E, validateSessionsCompactParams as Et, validateConnectParams as F, validateSessionsResolveParams as Ft, validateDevicePairRejectParams as G, validateToolsCatalogParams as Gt, validateCronUpdateParams as H, validateTalkConfigParams as Ht, validateCronAddParams as I, validateSessionsSendParams as It, validateDeviceTokenRotateParams as J, validateWakeParams as Jt, validateDevicePairRemoveParams as K, validateToolsEffectiveParams as Kt, validateCronListParams as L, validateSessionsUsageParams as Lt, validateConfigSchemaLookupResult as M, validateSessionsPatchParams as Mt, validateConfigSchemaParams as N, validateSessionsPreviewParams as Nt, validateConfigApplyParams as O, validateSessionsDeleteParams as Ot, validateConfigSetParams as P, validateSessionsResetParams as Pt, validateExecApprovalsNodeGetParams as Q, validateWizardNextParams as Qt, validateCronRemoveParams as R, validateSkillsBinsParams as Rt, validateChannelsLogoutParams as S, validateSecretsResolveParams as St, validateChatHistoryParams as T, validateSessionsAbortParams as Tt, validateDevicePairApproveParams as U, validateTalkModeParams as Ut, validateCronStatusParams as V, validateSkillsUpdateParams as Vt, validateDevicePairListParams as W, validateTalkSpeakParams as Wt, validateExecApprovalResolveParams as X, validateWebLoginWaitParams as Xt, validateExecApprovalRequestParams as Y, validateWebLoginStartParams as Yt, validateExecApprovalsGetParams as Z, validateWizardCancelParams as Zt, validateAgentsFilesGetParams as _, validatePluginApprovalRequestParams as _t, READ_SCOPE as a, resolveAuthConnectErrorDetailCode as an, validateNodeInvokeParams as at, validateAgentsListParams as b, validatePushTestParams as bt, isNodeRoleMethod as c, buildDeviceAuthPayload as cn, validateNodePairApproveParams as ct, formatValidationErrors as d, validateNodePairRequestParams as dt, validateWizardStatusParams as en, validateExecApprovalsSetParams as et, validateAgentIdentityParams as f, validateNodePairVerifyParams as ft, validateAgentsDeleteParams as g, validateNodeRenameParams as gt, validateAgentsCreateParams as h, validateNodePendingEnqueueParams as ht, PAIRING_SCOPE as i, ConnectErrorDetailCodes as in, validateNodeEventParams as it, validateConfigSchemaLookupParams as j, validateSessionsMessagesUnsubscribeParams as jt, validateConfigGetParams as k, validateSessionsListParams as kt, resolveLeastPrivilegeOperatorScopesForMethod as l, buildDeviceAuthPayloadV3 as ln, validateNodePairListParams as lt, validateAgentWaitParams as m, validateNodePendingDrainParams as mt, APPROVALS_SCOPE as n, errorShape as nn, validateModelsListParams as nt, WRITE_SCOPE as o, resolveDeviceAuthConnectErrorDetailCode as on, validateNodeInvokeResultParams as ot, validateAgentParams as p, validateNodePendingAckParams as pt, validateDeviceTokenRevokeParams as q, validateUpdateRunParams as qt, CLI_DEFAULT_OPERATOR_SCOPES as r, parseSessionLabel as rn, validateNodeDescribeParams as rt, authorizeOperatorScopesForMethod as s, getPreauthHandshakeTimeoutMsFromEnv as sn, validateNodeListParams as st, ADMIN_SCOPE as t, ErrorCodes as tn, validateLogsTailParams as tt, GatewayClient as u, normalizeFingerprint as un, validateNodePairRejectParams as ut, validateAgentsFilesListParams as v, validatePluginApprovalResolveParams as vt, validateChatAbortParams as w, validateSendParams as wt, validateAgentsUpdateParams as x, validateRequestFrame as xt, validateAgentsFilesSetParams as y, validatePollParams as yt, validateCronRunParams as z, validateSkillsInstallParams as zt };
