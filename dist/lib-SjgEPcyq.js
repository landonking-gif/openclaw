...
import { t as require_src } from "./src-Si71uT0Q.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-8l0Mis79.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-wvBJUIGZ.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-DU2Lb26l.js";
import { l as toRatio, n as decodeString } from "./Util-C50jcKM8.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CLwlUBtt.js";
import { t as APEv2Parser } from "./APEv2Parser-DUO-WVBQ.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CxrADFgH.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DsWKTQZ1.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-b0sp-IgZ.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-IhBJymku.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DQWxqaSu.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-Vrnxxwdi.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-D0MQttKX.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BeoaY38G.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Dx8u5cZ5.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CkFFc3r3.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Bzcm-JPy.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-FHzwdb4m.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-jhqzAWub.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BpTwACfN.js")).WaveParser;
	}
};
//#endregion
