...
import { S as sleep, x as shortenHomePath } from "./utils-ozuUQtXc.js";
import { n as isRich, r as theme, t as colorize } from "./theme-D-TumEpz.js";
import { _ as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-DQgqpvCf.js";
...
import { f as resolveGatewaySystemdServiceName, l as resolveGatewayLaunchAgentLabel } from "./constants-qlIzMva2.js";
import { s as trimToUndefined } from "./credential-planner-D2hepxEM.js";
import { n as isGatewaySecretRefUnavailableError } from "./credentials-D1xu0eMC.js";
import { i as parseStrictPositiveInteger } from "./parse-finite-number-Dituivqi.js";
import { d as loadGatewayTlsRuntime } from "./call-zb9A_l2V.js";
import { r as isWSLEnv } from "./wsl-B3mqSLaq.js";
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-IreFRnZR.js";
import { c as resolveGatewayLogPaths } from "./launchd-DcgU3_4R.js";
import { r as resolveGatewayService } from "./service-DIngRSi2.js";
import { a as inspectPortUsage, o as classifyPortListener, s as formatPortDiagnostics } from "./ports-aadA2H0l.js";
import { t as killProcessTree } from "./kill-tree-Cyuahad9.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-TTLn5Hhj.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-BvO9R4Ry.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CJcjwBjD.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-DGoT7JUw.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-CPvInm3L.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-DQjFf8Se.js");
