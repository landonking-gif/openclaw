...
import { T as truncateUtf16Safe, v as resolveUserPath } from "./utils-ozuUQtXc.js";
...
import { r as listMemoryEmbeddingProviders, t as getMemoryEmbeddingProvider } from "./memory-embedding-providers-D3_o9ASE.js";
import { n as getProviderEnvVars } from "./provider-env-vars-CD3WhA3k.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-CMp00w2M.js";
import { t as resolveMemorySearchConfig } from "./memory-search-Blud1nyM.js";
import { t as extractKeywords } from "./query-expansion-B34g1sl8.js";
import { l as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "./ollama-Bis6U3JS.js";
import { _ as estimateUtf8Bytes, a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, g as estimateStructuredEmbeddingInputBytes, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-Bmt5FrEu.js";
import { r as readMemoryFile } from "./backend-config-GHx6Sxa5.js";
import { a as runGeminiEmbeddingBatches, c as DEFAULT_VOYAGE_EMBEDDING_MODEL, d as createOpenAiEmbeddingProvider, f as DEFAULT_MISTRAL_EMBEDDING_MODEL, g as createGeminiEmbeddingProvider, h as buildGeminiEmbeddingRequest, i as runOpenAiEmbeddingBatches, l as createVoyageEmbeddingProvider, m as DEFAULT_GEMINI_EMBEDDING_MODEL, n as runVoyageEmbeddingBatches, o as DEFAULT_LOCAL_MODEL, p as createMistralEmbeddingProvider, r as OPENAI_BATCH_ENDPOINT, s as createLocalEmbeddingProvider, t as enforceEmbeddingMaxInputTokens, u as DEFAULT_OPENAI_EMBEDDING_MODEL } from "./memory-core-host-engine-embeddings-CkU_6K4J.js";
import "./memory-core-host-engine-foundation-CjUoFvYm.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, u as sessionPathForFile } from "./memory-core-host-engine-qmd-BTsDI7cC.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./memory-core-host-engine-storage-DWBJT3_e.js";
import "./provider-env-vars-CNPPIyWv.js";
