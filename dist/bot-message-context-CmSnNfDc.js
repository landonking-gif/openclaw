...
import { t as firstDefined } from "./allow-from-CI3CEDyI.js";
...
import { a as buildPendingHistoryContextFromMap, u as recordPendingHistoryEntryIfEnabled } from "./history-hQFGL-sK.js";
...
import { a as createStatusReactionController, n as DEFAULT_EMOJIS } from "./channel-feedback-CG8Loxh9.js";
...
async function resolveStickerVisionSupport(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-DVsGdPaL.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-Cpr5Gh6J.js");
