...
import { t as listConfiguredAccountIds } from "./account-core-DE1yHvh3.js";
...
function hasReadyEffectiveMatrixAccountSource(params) {
	...
	return hasUsableResolvedMatrixAuth(resolveMatrixAccountStringValues({
...
function resolveConfiguredMatrixAccountIds(cfg, env = process.env) {
	...
	return listCombinedAccountIds({
		...
		additionalAccountIds: listMatrixEnvAccountIds(env).filter((accountId) => hasReadyEffectiveMatrixAccountSource({
			channel,
			accountId,
			env
		})),
