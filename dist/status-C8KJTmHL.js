...
import { n as getNodeDaemonStatusSummary, t as getDaemonStatusSummary } from "./status.daemon-CVxTo20O.js";
import "./status.summary-Bm-3pmcX.js";
...
function loadProviderUsage() {
	providerUsagePromise ??= import("./provider-usage-CdeN-JS5.js");
	return providerUsagePromise;
}
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-fLLrsAc5.js");
...
function loadStatusScanModule() {
	statusScanModulePromise ??= import("./status.scan-BcErTrQf.js");
	return statusScanModulePromise;
}
function loadStatusScanFastJsonModule() {
	statusScanFastJsonModulePromise ??= import("./status.scan.fast-json-BZAeCw8t.js");
	return statusScanFastJsonModulePromise;
}
function loadStatusAllModule() {
	statusAllModulePromise ??= import("./status-all-DAxzdhTM.js");
	return statusAllModulePromise;
}
function loadStatusCommandTextRuntime() {
	statusCommandTextRuntimePromise ??= import("./status.command.text-runtime-CfgGrUte.js");
	return statusCommandTextRuntimePromise;
}
function loadStatusNodeModeModule() {
	statusNodeModeModulePromise ??= import("./status.node-mode-gxwI9cOP.js");
