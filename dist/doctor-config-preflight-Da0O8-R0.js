...
import { f as readConfigFileSnapshot, z as OpenClawSchema } from "./io-D4TfzS5d.js";
import "./config-XFKRjuRh.js";
import { n as formatConfigIssueLines } from "./issue-format-daawrNm3.js";
import { t as note } from "./note-CbiZEShZ.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DTT0pLZu.js");
