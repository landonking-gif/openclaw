...
import { f as readConfigFileSnapshot } from "./io-D4TfzS5d.js";
...
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BWbT1YJU.js";
...
import { t as runSetupWizard } from "./setup-DdVofQRz.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-DAB7we8N.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-VnjAKx-8.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-o9eazYj8.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-D9_Vy_WK.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-S3G39-PR.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Cvuqcm-l.js");
