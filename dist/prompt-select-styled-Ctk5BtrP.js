...
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-y1lXgzE3.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-CukZID_h.js";
...
import { Ft as resolveNormalizedProviderModelMaxTokens, G as isTrustedSafeBinPath, It as LEGACY_TALK_PROVIDER_ID, N as migrateLegacyConfig, Rt as normalizeTalkSection, W as getTrustedSafeBinDirs, Y as listRiskyConfiguredSafeBins, dt as resolveCommandResolutionFromArgv, f as readConfigFileSnapshot, q as normalizeTrustedSafeBinDirs, x as writeConfigFile } from "./io-D4TfzS5d.js";
import { C as resolveDiscordPreviewStreamMode, E as resolveTelegramPreviewStreamMode, T as resolveSlackStreamingMode, b as formatSlackStreamModeMigrationMessage, w as resolveSlackNativeStreaming, x as formatSlackStreamingBooleanMigrationMessage } from "./zod-schema.providers-core-DtTlbX_O.js";
...
import { d as resolveProfileUnusableUntilForDisplay } from "./order-D6g7Gz1k.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-BHGq763c.js";
...
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-BPx3Kezz.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-9ht4WbxI.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CDm-glWj.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-BQ2VxgNP.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-ufRGHFYT.js";
import { a as readGatewayTokenEnv } from "./credential-planner-DLqjCQ1O.js";
...
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-DEeOfjFm.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-DWiJhWZh.js";
import "./plugins-B9ydw93g.js";
import { i as resolveMainSessionKey } from "./main-session-BBpmPNJV.js";
import { i as resolveAgentSessionDirs } from "./sessions-B4aC8Aau.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-sf4ch2Nw.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-CqDPDxCm.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-KV9lqGMw.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-WcuBXDTZ.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-tzUjXbVe.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-C1EDtsRh.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-BWbT1YJU.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-EJV0UzNN.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BoGcEsGy.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CXcGwK73.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-DAmuSUhy.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-CG7Kdyxh.js";
...
import { n as formatConfigIssueLines } from "./issue-format-daawrNm3.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-DhaHHyzz.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-C0hdXEWc.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DyB6Nj8P.js";
import { r as listPotentialConfiguredChannelIds } from "./config-presence-DJCqYN0y.js";
import { a as readChannelAllowFromStore } from "./pairing-store-CGyjsUKG.js";
...
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-BktCfJi_.js";
import { Y as readBrowserVersion, nt as resolveGoogleChromeExecutableForPlatform, q as parseBrowserMajorVersion } from "./browser-runtime-ZJ4YExWu.js";
import "./sandbox-BnbuS4KL.js";
import { o as resolveApiKeyForProvider } from "./model-auth-CRn7ZlFJ.js";
import { b as resolveBootstrapContextForRun, g as TrimmedNonEmptyStringFieldSchema, m as LowercaseNonEmptyStringFieldSchema, n as buildBootstrapInjectionStats, p as DeliveryThreadIdFieldSchema, s as inferLegacyName, t as analyzeBootstrapBudget, u as normalizeOptionalText, v as parseOptionalField } from "./bootstrap-budget-Cl2sJ2Ol.js";
import { H as resolveBootstrapMaxChars, W as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-D-NRJ7pw.js";
import { t as migrateLegacyWebSearchConfig } from "./legacy-web-search-Bcw3O5sE.js";
import { b as resolveExecApprovalsFromFile, l as minSecurity, o as loadExecApprovals, s as maxAsk } from "./exec-approvals-CzqGD3AZ.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-G3eN6WkZ.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-JeXwYyCd.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-BQ4-ntko.js";
import { i as listRouteBindings } from "./bindings-CNW3-Htb.js";
import { r as resolveActiveMemoryBackendConfig } from "./memory-runtime-BiysfrkY.js";
import { t as resolveMemorySearchConfig } from "./memory-search-Blud1nyM.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-DgJhtRQj.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-DPpYfcGE.js";
import { n as logConfigUpdated } from "./logging-hznOPJDM.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-Ckn_DEQl.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-G0DZk90K.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-CD9xWkDA.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-D_eOsQXQ.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-CmYAlCIk.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-GHx6Sxa5.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-CkU_6K4J.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-DOGe3oWw.js";
import { t as checkQmdBinaryAvailability } from "./memory-core-host-engine-qmd-BTsDI7cC.js";
import "./memory-core-host-engine-storage-DWBJT3_e.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C4sCEphW.js";
import { a as buildPluginStatusReport, r as buildPluginCompatibilityWarnings } from "./status-D4YvnqwG.js";
import { t as note$1 } from "./note-CbiZEShZ.js";
import { r as healthCommand } from "./health-DitF78AQ.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DaO4kdva.js";
import { g as coerceFiniteScheduleNumber, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-DYePP9Ci.js";
import { i as normalizeTelegramAllowFromEntry, n as isNumericTelegramUserId, r as listTelegramAccountIds, t as inspectTelegramAccount } from "./read-only-account-inspect.telegram-YTnCAilt.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-1PjnxbP-.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-CF8a-7oE.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CtnlJITQ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CuFZXpA6.js";
import { t as formatHealthCheckFailure } from "./health-format-CqbopIdJ.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-Da0O8-R0.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors--c0-qT37.js";
import { n as doctorShellCompletion } from "./doctor-completion-BGl7n5Nv.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-A65kxQlw.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-KeQ0uviL.js";
import "./doctor-state-migrations-DctUUnRN.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-DwVuBCss.js";
