...
import { n as buildGatewayConnectionDetails } from "./call-zb9A_l2V.js";
import { a as omitEnvKeysCaseInsensitive, r as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-BouozYy1.js";
import { r as isKnownCoreToolId } from "./tool-catalog-CWWX0Q8P.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-Cr88dzlh.js";
import { r as listThinkingLevels } from "./thinking-DbOLW6oi.js";
import { r as isMutatingToolCall } from "./tool-mutation-CTi_1ZGc.js";
...
import { t as readSecretFromFile } from "./secret-file-BVETTeS7.js";
...
function classifyAcpToolApproval(params) {
	...
	if (INTERACTIVE_TOOL_IDS.has(toolName)) return {
		toolName,
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-B1huBm5U.js");
