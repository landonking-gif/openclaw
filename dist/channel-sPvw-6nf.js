...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CtC8UKdv.js";
...
import { f as createAllowlistProviderOpenWarningCollector, y as projectAccountConfigWarningCollector } from "./group-policy-warnings-CO0Z-uz1.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate } from "./common-DotKVabV.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-DShlDMvu.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-BMw9_-BI.js";
...
import { r as buildTrafficStatusSummary } from "./extension-shared-DQHeL7JC.js";
import "./channel-status-BPQoZP2k.js";
import { t as zod_exports } from "./zod-BREmy5IG.js";
import { d as requiresExplicitMatrixDefaultAccount } from "./storage-paths-BOnyRjh-.js";
import { a as resolveMatrixAccountConfig, i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-ERQaGWNS.js";
import "./runtime-api-D7PTL6Yn.js";
import { n as normalizeMatrixAllowList, r as normalizeMatrixUserId, t as resolveMatrixRoomConfig } from "./rooms-Cx9ibB7B.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-6vsy2qIj.js";
...
import { t as matrixSetupAdapter } from "./setup-core-D7dr_MML.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-B6V8MWow.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CqQdeNX6.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-IovoRysC.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
