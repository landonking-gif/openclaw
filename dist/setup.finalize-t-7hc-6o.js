...
import { m as pathExists, v as resolveUserPath } from "./utils-ozuUQtXc.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BUc4RCkE.js";
import { n as resolveCliName } from "./cli-name-CMO2QFOk.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-DUbHnyBV.js";
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-IreFRnZR.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DIngRSi2.js";
import { i as isSystemdUserServiceAvailable } from "./systemd-TTLn5Hhj.js";
import { t as listConfiguredWebSearchProviders } from "./runtime-B1jF5Pjq.js";
...
import { t as runTui } from "./tui-DB4wR7Ql.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Dpi9aiBw.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-DE5WE_0b.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-k309dcfa.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-k309dcfa.js");
