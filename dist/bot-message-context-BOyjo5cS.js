...
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-4QR94Oth.js";
...
import { t as firstDefined } from "./allow-from-DXe6niqf.js";
import { n as evaluateMatchedGroupAccessForPolicy } from "./group-access-UN2ChzOn.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist } from "./dm-policy-shared-DGVIISSQ.js";
import { a as buildPendingHistoryContextFromMap, u as recordPendingHistoryEntryIfEnabled } from "./history-CYQfJBwi.js";
...
import { a as createStatusReactionController, n as DEFAULT_EMOJIS } from "./channel-feedback-CRh-gYDv.js";
...
import { C as normalizeForwardedContext, I as isSenderAllowed, L as normalizeAllowFrom, O as resolveTelegramMediaPlaceholder, R as normalizeDmAllowFromWithStore, S as hasBotMention, T as resolveTelegramForumFlag, _ as describeReplyTarget, b as extractTelegramLocation, c as buildGroupLabel, d as buildTelegramGroupFrom, f as buildTelegramGroupPeerId, g as buildTypingThreadParams, i as renderTelegramHtmlText, j as resolveTelegramThreadSpec, l as buildSenderLabel, p as buildTelegramParentPeer, s as withTelegramApiErrorLogging, u as buildSenderName, v as expandTextLinks, w as resolveTelegramDirectPeerId, x as getTelegramTextParts, y as extractTelegramForumFlag, z as resolveSenderAllowMatch } from "./format-D28ImD7P.js";
...
async function resolveStickerVisionSupport(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-MXH4yIgr.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-vt3XN6Ag.js");
...
//#endregion
export { evaluateTelegramGroupPolicyAccess as a, resolveTelegramConversationRoute as c, evaluateTelegramGroupBaseAccess as i, enforceTelegramDmAccess as n, resolveTelegramRuntimeGroupPolicy as o, resolveTelegramGroupPromptSettings as r, resolveTelegramConversationBaseSessionKey as s, buildTelegramMessageContext as t };
