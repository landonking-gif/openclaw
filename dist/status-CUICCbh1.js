...
import { s as trimToUndefined } from "./credential-planner-DLqjCQ1O.js";
import { n as isGatewaySecretRefUnavailableError } from "./credentials-BmTebhJx.js";
import { i as parseStrictPositiveInteger } from "./parse-finite-number-BbGMkOzg.js";
import { d as loadGatewayTlsRuntime } from "./call-WcuBXDTZ.js";
import { r as isWSLEnv } from "./wsl-C1EDtsRh.js";
import { _ as inspectBestEffortPrimaryTailnetIPv4, f as resolveControlUiLinks, y as resolveBestEffortGatewayBindHostForDisplay } from "./onboard-helpers-BWbT1YJU.js";
import { c as resolveGatewayLogPaths } from "./launchd-BoGcEsGy.js";
import { r as resolveGatewayService } from "./service-CXcGwK73.js";
import { a as inspectPortUsage, o as classifyPortListener, s as formatPortDiagnostics } from "./ports-DAmuSUhy.js";
import { t as killProcessTree } from "./kill-tree-CVuRWbki.js";
import { p as classifySystemdUnavailableDetail } from "./systemd-CG7Kdyxh.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-BsKkUzsX.js";
import { d as resolveDaemonContainerContext, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-BdEUK9Wv.js";
...
import { i as resolveGatewayProbeAuthWithSecretInputs } from "./probe-auth-CD37tcEL.js";
...
async function probeGatewayStatus(opts) {
	try {
		const result = await withProgress({
			...
			if (opts.requireRpc) {
				const { callGateway } = await import("./call-5zC80xf7.js");
				await callGateway({
					url: opts.url,
					token: opts.token,
			...
			const { probeGateway } = await import("./probe-Uw7hb2rK.js");
