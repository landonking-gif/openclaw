import { i as formatUncaughtError, r as formatErrorMessage } from "./errors-Bs2h5H8p.js";
...
import { m as defaultRuntime, p as createNonExitingRuntime, t as createSubsystemLogger } from "./subsystem-CJEvHE2o.js";
...
import { _ as normalizeAccountId, d as resolveThreadSessionKeys } from "./session-key-4QR94Oth.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId } from "./agent-scope-jbts6oCz.js";
import { g as resolveDefaultModelForAgent } from "./model-selection-D90MGDui.js";
import { Bt as resolveAgentMaxConcurrent, c as loadConfig, o as getRuntimeConfigSnapshot, x as writeConfigFile } from "./io-CHHRUM9X.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./telegram-custom-commands-BqZlb_xX.js";
import { c as resolveSessionStoreEntry, d as updateSessionStore, i as loadSessionStore } from "./store-1GMpznZw.js";
import { l as resolveStorePath } from "./paths-BC0JJAKv.js";
import { c as getAgentScopedMediaLocalRoots, d as MediaFetchError, t as loadWebMedia } from "./web-media-CkaAIY0r.js";
import "./web-media-DXbVsiyW.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled, n as isNativeCommandsExplicitlyDisabled } from "./commands-Dl-S3AjE.js";
import { _ as resolveChannelConfigWrites } from "./channel-config-helpers-XkwmfU3s.js";
...
import { m as dispatchPluginInteractiveHandler, v as getPluginCommandSpecs } from "./types-CNVNmBVr.js";
import { t as createDedupeCache } from "./dedupe-D3FBt-KE.js";
import { a as registerSessionBindingAdapter, o as unregisterSessionBindingAdapter } from "./session-binding-service-BWEN0bmc.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval } from "./conversation-binding-DMn9Y9aU.js";
import { W as buildCommandsMessagePaginated } from "./pi-embedded-Hk8nEay3.js";
import { n as isDiagnosticsEnabled } from "./diagnostic-events-CclpaXPl.js";
import { _ as startDiagnosticHeartbeat, f as logWebhookError, m as logWebhookReceived, p as logWebhookProcessed, v as stopDiagnosticHeartbeat } from "./diagnostic-BXZZUeo4.js";
...
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-CJVpH0Ce.js";
import { t as waitForAbortSignal } from "./abort-signal-DjE4_CRs.js";
import { r as formatDurationPrecise } from "./format-duration-CeNhXU1K.js";
import "./runtime-env-qZTXn_g8.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-DsMUguiY.js";
import "./text-runtime-CaFf_6Rl.js";
import { n as findCodeRegions, r as isInsideCode, t as stripReasoningTagsFromText } from "./reasoning-tags-i18t95A4.js";
import { a as buildExecApprovalPendingReplyPayload, u as parseExecApprovalCommandText } from "./exec-approval-reply-Dh5fPINs.js";
import { _ as formatReasoningMessage } from "./minimax-vlm-Qh0ipRyy.js";
...
import { i as resolveAgentRoute } from "./resolve-route-Dm396btS.js";
import { i as matchPluginCommand, n as executePluginCommand } from "./commands-hBy8LTfU.js";
import { d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, m as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, u as listNativeCommandSpecs } from "./commands-registry-DEdU8RQh.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-Rwjq4YCA.js";
import { c as resolveThreadBindingIdleTimeoutMsForChannel, d as resolveThreadBindingMaxAgeMsForChannel, g as formatThreadBindingDurationLabel, o as resolveThreadBindingEffectiveExpiresAt, p as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-BbiHFl-r.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-DD8wDxR4.js";
import "./core-BD-JWpum.js";
import "./routing-C41nSjtW.js";
import { t as resolveTelegramToken } from "./token-ChYTJ7Io.js";
import { n as isAbortRequestText } from "./abort-primitives-C81lrxZX.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-CRMQGdF3.js";
import { t as removeAckReactionAfterReply } from "./ack-reactions-CvbsV5cS.js";
import { t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-B8MvYTwH.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-F207V1-8.js";
import { t as resolveCommandAuthorization } from "./command-auth-BlBs2ty0.js";
import { i as resolveStoredModelOverride } from "./model-selection-UW5djlO6.js";
import { s as clearHistoryEntriesIfEnabled } from "./history-CYQfJBwi.js";
import "./reply-history-DaHn-Tkh.js";
import { n as resolveApprovalRequestAccountId, o as resolveExecApprovalCommandDisplay, r as resolveApprovalRequestOriginTarget } from "./exec-approval-session-target-B-Xxpasz.js";
import { n as createApproverRestrictedNativeApprovalAdapter } from "./approval-runtime-BxXp_f2n.js";
import { a as matchesApprovalRequestFilters, r as buildPluginApprovalPendingReplyPayload } from "./approval-renderers-Bd8LFYmz.js";
import "./config-runtime-BpMmx6Pn.js";
import { n as isBtwRequestText } from "./btw-command-BGDfSqyx.js";
import { n as resolveAutoTopicLabelConfig, t as generateTopicLabel } from "./reply-runtime-Ds_SHc8s.js";
import "./reply-dispatch-runtime-DmkPNXI4.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-BkyGa5kN.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-jXzo5gTe.js";
import { r as createExecApprovalChannelRuntime, t as deliverApprovalRequestViaChannelNativePlan } from "./infra-runtime-CQ-OycVz.js";
...
import { n as recordInboundSessionMetaSafe, r as ensureConfiguredBindingRouteReady, t as resolveThreadBindingConversationIdFromBindingId } from "./conversation-runtime-D6FkTbc9.js";
import "./agent-runtime-CPWHkM9s.js";
import "./plugin-runtime-DKuaAb9V.js";
import "./gateway-runtime-BZ-xak-n.js";
import { n as formatModelsAvailableHeader, t as buildModelsProviderData } from "./commands-models-D6KUWooJ.js";
import "./markdown-table-runtime-BZ3hGo1I.js";
import { r as logTypingFailure, t as logAckFailure } from "./logging-DUUOiP8V.js";
import { t as extractToolSend } from "./tool-send-Bj51u5jr.js";
import { a as createFixedWindowRateLimiter, r as WEBHOOK_RATE_LIMIT_DEFAULTS } from "./webhook-memory-guards-Bx5okKue.js";
import { r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-CdEpsABJ.js";
import "./webhook-ingress-BWcTICaS.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-KjWERARH.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-BC_T9NCV.js";
import { t as buildCommandsPaginationKeyboard } from "./commands-info-DYqFqD-m.js";
import "./command-auth-Cm9A1xQ-.js";
import "./command-auth-native-B51NN3Qu.js";
import "./error-runtime-CrSEUb2n.js";
import { a as listTokenSourcedAccounts, i as createUnionActionGate, r as resolveReactionMessageId, t as createMessageToolButtonsSchema } from "./channel-actions-FtN0Fb9u.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-CFiZXQsp.js";
import { i as createFinalizableDraftLifecycle } from "./channel-lifecycle-C-w8XWq8.js";
import "./state-paths-Dr1R5aH8.js";
import "./telegram-core-D76sgmbe.js";
import { l as resolveTelegramPollActionGateState, n as listEnabledTelegramAccounts, r as listTelegramAccountIds, s as resolveTelegramAccount, t as createTelegramActionGate } from "./accounts-B0QkT0Pt.js";
import { a as resolveTelegramTargetChatType, i as parseTelegramTarget, n as normalizeTelegramChatId } from "./targets-CIpGPpeB.js";
import { r as resolveTelegramTransport } from "./fetch-DIL40Dux.js";
import { c as shouldEnableTelegramExecApprovalButtons, d as isTelegramInlineButtonsEnabled, i as isTelegramExecApprovalClientEnabled, n as isTelegramExecApprovalApprover, o as resolveTelegramExecApprovalConfig, p as resolveTelegramInlineButtonsScope, r as isTelegramExecApprovalAuthorizedSender, s as resolveTelegramExecApprovalTarget, t as getTelegramExecApprovalApprovers, u as shouldSuppressLocalTelegramExecApprovalPrompt } from "./exec-approvals-Cd3HMwip.js";
import { A as resolveTelegramStreamMode, D as resolveTelegramGroupAllowFromContext, E as resolveTelegramForumThreadId, I as isSenderAllowed, M as withResolvedTelegramForumFlag, N as normalizeTelegramReplyToMessageId, R as normalizeDmAllowFromWithStore, T as resolveTelegramForumFlag, d as buildTelegramGroupFrom, f as buildTelegramGroupPeerId, h as buildTelegramThreadParams, i as renderTelegramHtmlText, j as resolveTelegramThreadSpec, m as buildTelegramRoutingTarget, p as buildTelegramParentPeer, s as withTelegramApiErrorLogging, u as buildSenderName, x as getTelegramTextParts, y as extractTelegramForumFlag } from "./format-D28ImD7P.js";
import { a as buildModelsKeyboard, c as getModelsPageSize, l as parseModelCallbackData, m as resolveTelegramInlineButtons, o as buildProviderKeyboard, p as resolveTelegramReactionLevel, s as calculateTotalPages, u as resolveModelSelection } from "./probe-BUg1dGGW.js";
import { C as isRecoverableTelegramNetworkError, D as tagTelegramNetworkError, E as isTelegramPollingNetworkError, S as wasSentByBot, T as isTelegramClientRejection, _ as sendPollTelegram, c as createForumTopicTelegram, d as editMessageReplyMarkupTelegram, f as editMessageTelegram, g as sendMessageTelegram, i as getCacheStats, l as deleteMessageTelegram, m as reactMessageTelegram, n as describeStickerImage, o as searchStickers, s as buildInlineKeyboard, t as cacheSticker, u as editForumTopicTelegram, v as sendStickerTelegram, w as isSafeToRetrySendError, y as sendTypingTelegram } from "./sticker-cache-pxzAsj2-.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-paM-nQDQ.js";
import { a as evaluateTelegramGroupPolicyAccess, c as resolveTelegramConversationRoute, i as evaluateTelegramGroupBaseAccess, n as enforceTelegramDmAccess, r as resolveTelegramGroupPromptSettings, s as resolveTelegramConversationBaseSessionKey, t as buildTelegramMessageContext } from "./bot-message-context-BOyjo5cS.js";
import { n as readTelegramUpdateOffset, r as writeTelegramUpdateOffset } from "./update-offset-store-BJzvmkaf.js";
...
const telegramNativeApprovalAdapter = createApproverRestrictedNativeApprovalAdapter({
	...
	resolveOriginTarget: ({ cfg, accountId, request }) => accountId ? resolveTelegramOriginTarget({
		cfg,
		accountId,
		request
	}) : null,
	resolveApproverDmTargets: ({ cfg, accountId }) => resolveTelegramApproverDmTargets({
		cfg,
		accountId
	})
});
...
function resolveBoundTelegramAccountId(params) {
	return resolveApprovalRequestAccountId({
		cfg: params.cfg,
		request: params.request,
		channel: params.request.request.turnSourceChannel?.trim().toLowerCase() === "telegram" ? null : "telegram"
	});
}
function matchesFilters(params) {
	...
	if (boundAccountId && normalizeAccountId(boundAccountId) !== normalizeAccountId(params.accountId)) return false;
	return true;
}
...
var TelegramExecApprovalHandler = class {
	constructor(opts, deps = {}) {
		...
		this.runtime = createExecApprovalChannelRuntime({
			...
			shouldHandle: (request) => matchesFilters({
				cfg: this.opts.cfg,
				accountId: this.opts.accountId,
				request
			}),
	...
	async deliverRequested(request) {
		const approvalKind = request.id.startsWith("plugin:") ? "plugin" : "exec";
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-Cv_yoGyV.js");
...
//#endregion
export { setTelegramThreadBindingIdleTimeoutBySessionKey as a, telegramMessageActions as c, resetTelegramThreadBindingsForTests as i, handleTelegramAction as l, createTelegramThreadBindingManager as n, setTelegramThreadBindingMaxAgeBySessionKey as o, getTelegramThreadBindingManager as r, telegramMessageActionRuntime as s, monitorTelegramProvider as t, telegramNativeApprovalAdapter as u };
