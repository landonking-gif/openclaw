...
import { r as loadAuthProfileStore } from "./store-y1lXgzE3.js";
import "./auth-profiles-CukZID_h.js";
import { t as danger } from "./globals-DhgSPxVV.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BLDB43BH.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-C34Ifo_y.js";
...
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-De_e7N1V.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-CShn1ZqF.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-Bvn6PX34.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-haCVr5TZ.js";
import { t as parseLogLine } from "./parse-log-line-BHcLzyzI.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-BjLob2P_.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-Dm6szp85.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-ChaouFAf.js"), import("./onboard-channels-DrhA-ZLS.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CfOTuXBj.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CfOTuXBj.js");
			const prompter = createClackPrompter();
