...
import { t as sameFileIdentity } from "./file-identity-Cyn-N_Re.js";
import { i as resolveAgentConfig } from "./agent-scope-jbts6oCz.js";
import { a as logWarn } from "./logger-BGSZ8m40.js";
import { At as normalizeExecutableToken, Dt as resolveInlineCommandMatch, Tt as POSIX_INLINE_COMMAND_FLAGS, Z as analyzeArgvCommand, _t as resolveExecutableFromPathEnv, c as loadConfig, dt as resolveCommandResolutionFromArgv, kt as unwrapKnownDispatchWrapperInvocation, lt as resolveApprovalAuditCandidatePath, rt as resolvePlannedSegmentArgv, wt as unwrapKnownShellMultiplexerInvocation, yt as POSIX_SHELL_WRAPPERS } from "./io-CHHRUM9X.js";
import { a as sanitizeHostExecEnv, s as sanitizeSystemRunEnvOverrides, t as inspectHostExecEnvOverrides } from "./host-env-security-BfF8rbgr.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-qlIzMva2.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-G34BbStd.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-xeTiU5Rk.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CI1Fmm6N.js";
...
import { u as GatewayClient } from "./method-scopes-DOxx6FV1.js";
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BvO9R4Ry.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CJcjwBjD.js";
import { t as parsePort } from "./parse-port-jgse0FHW.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-B7hzwa0G.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CvKK9_HX.js";
import { $ as resolveBrowserConfig, at as runBrowserProxyCommand } from "./browser-runtime-KakgW5BZ.js";
import { C as saveExecApprovals, E as evaluateShellAllowlist, M as detectInterpreterInlineEvalArgv, T as evaluateExecAllowlist, a as hasDurableExecApproval, c as mergeExecApprovalsSocketDefaults, g as recordAllowlistUse, h as readExecApprovalsSnapshot, i as ensureExecApprovals, j as describeInterpreterInlineEval, k as resolveAllowAlwaysPatterns, n as addAllowlistEntry, r as addDurableCommandApproval, u as normalizeExecApprovals, v as requiresExecApproval, w as requestJsonlSocket, y as resolveExecApprovals } from "./exec-approvals-DhhaUSQB.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-D4zFHAus.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands---sX8e2e.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-C4tGQzir.js";
import { t as formatHelpExamples } from "./help-format-CjNbejox.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-KXRBgFs1.js";
import { t as resolveNodeService } from "./node-service-CfajOLnT.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-FqmycFoZ.js";
...
async function executeSystemRunPhase(opts, phase) {
	...
	if (phase.policy.approvalDecision === "allow-always" && phase.inlineEvalHit === null) {
		...
		for (const pattern of patterns) if (pattern) addAllowlistEntry(phase.approvals.file, phase.agentId, pattern, { source: "allow-always" });
		if (patterns.length === 0) addDurableCommandApproval(phase.approvals.file, phase.agentId, phase.commandText);
	}
