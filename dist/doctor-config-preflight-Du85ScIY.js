import { g as resolveHomeDir, u as isRecord } from "./utils-ozuUQtXc.js";
import { t as CONFIG_PATH } from "./paths-DQgqpvCf.js";
import { f as readConfigFileSnapshot, z as OpenClawSchema } from "./io-CHHRUM9X.js";
import "./config-B3X9mknZ.js";
import { n as formatConfigIssueLines } from "./issue-format-CJ9Q2b0V.js";
import { t as note } from "./note-DtFCCVBg.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-CuMAi3U6.js");
