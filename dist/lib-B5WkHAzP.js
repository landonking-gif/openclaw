...
import { t as require_src } from "./src-CeIdFvWx.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-ClgnSM9z.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CNYKEXPm.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-Xg8CCGIC.js";
import { l as toRatio, n as decodeString } from "./Util-D2an2Vq1.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-B8bk8CaB.js";
import { t as APEv2Parser } from "./APEv2Parser-TG0VZLly.js";
import { r as hasID3v1Header } from "./ID3v1Parser-C2BBcFXE.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-xm4XZ_kc.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-VSC03LIE.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BeCUFwOT.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-COr-4P-S.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-D-Pg4syF.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DfRJTM3B.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DpaXCkUY.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Ye0273Rb.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DsnmEe6k.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CIW_b8Co.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DGfU4qaO.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-D48brG2f.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Bn4VCQmZ.js")).WaveParser;
	}
};
//#endregion
