...
import { r as loadAuthProfileStore } from "./store-CTbjH_aB.js";
...
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-C-i_GiCo.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DEzGAuKX.js";
...
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-BDJ5CCih.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-sac0o-a5.js";
import { n as formatTimeAgo } from "./format-relative-Bz4Y_eGX.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-CRZTVTc7.js";
import { t as createClackPrompter } from "./clack-prompter-DzouJyrf.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DgIKfiIX.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DAoJgupP.js";
import { t as parseLogLine } from "./parse-log-line-CiPFPcbD.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-KzpDXNqo.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-Bu2Lct2O.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-BKP9EoNG.js"), import("./onboard-channels-Bmr6j4rY.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-5Ng29oRM.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-5Ng29oRM.js");
			const prompter = createClackPrompter();
