...
import { r as resolveDefaultGroupPolicy } from "./runtime-group-policy-jTYTnisD.js";
...
import { x as buildMediaPayload } from "./reply-payload-DFX4yBqp.js";
import { r as resolveDualTextControlCommandGate } from "./command-gating-DB40LexH.js";
...
import { A as isRecord, C as IMG_SRC_RE, D as inferPlaceholder, E as extractInlineImageCandidates, F as resolveRequestUrl, I as safeFetchWithPolicy, L as safeHostForUrl, M as normalizeContentType, N as resolveAttachmentFetchPolicy, O as isDownloadableAttachment, P as resolveMediaSsrfPolicy, S as GRAPH_ROOT, T as extractHtmlFromAttachment, _ as loadMSTeamsSdkWithAuth, f as resolveMSTeamsCredentials, g as createMSTeamsTokenProvider, h as createMSTeamsAdapter, i as fetchGraphJson, j as isUrlAllowed, k as isLikelyImageAttachment, m as createBotFrameworkJwtValidator, w as applyAuthorizationHeaderForUrl, x as ATTACHMENT_TAG_RE, y as getMSTeamsRuntime } from "./graph-users-D9S5sRYV.js";
import { o as resolveMSTeamsChannelAllowlist, s as resolveMSTeamsUserAllowlist } from "./resolve-allowlist-C9gNQeRh.js";
import { a as resolveMSTeamsRouteConfig, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, t as isMSTeamsGroupAllowed } from "./policy-C0mgs0Wg.js";
import { S as createMSTeamsConversationStoreFs, _ as classifyMSTeamsSendError, b as createMSTeamsPollStoreFs, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as getPendingUpload, g as uploadToConsentUrl, h as parseFileConsentInvoke, l as sendMSTeamsMessages, m as buildFileInfoCard, p as removePendingUpload, s as buildConversationReference, u as AI_GENERATED_ENTITY, v as formatMSTeamsSendErrorHint, x as extractMSTeamsPollVote, y as formatUnknownError } from "./probe-DFT9TOCQ.js";
...
function createTeamsReplyStreamController(params) {
	...
	return {
		...
		preparePayload(payload) {
			if (!stream || !streamReceivedTokens || !stream.hasContent || stream.isFinalized) return payload;
