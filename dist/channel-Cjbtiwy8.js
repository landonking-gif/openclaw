import { c as GroupPolicySchema, m as MarkdownConfigSchema } from "./zod-schema.core-ZvH5iguE.js";
import { i as buildNestedDmConfigSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-Cl_s6UTH.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DyX-NNWd.js";
import { n as describeAccountSnapshot } from "./account-helpers-DaxrMp_H.js";
import { c as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor, u as createScopedDmSecurityResolver } from "./channel-config-helpers-XkwmfU3s.js";
import { f as createAllowlistProviderOpenWarningCollector, y as projectAccountConfigWarningCollector } from "./group-policy-warnings-76l7Zlnx.js";
import { d as readNumberParam, h as readStringParam, i as createActionGate } from "./common-DbyForkU.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-WMlTFWAj.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-B8PM47Il.js";
...
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-DG1RRDLI.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-BUlK5PT2.js";
...
import { r as buildTrafficStatusSummary } from "./extension-shared-kKSSjK8x.js";
import "./channel-status-BFxESRDM.js";
import { t as zod_exports } from "./zod-3odrtx2G.js";
import { d as requiresExplicitMatrixDefaultAccount } from "./storage-paths-cRdwekZZ.js";
import { a as resolveMatrixAccountConfig, i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-DyuKZNA3.js";
import "./runtime-api-DzVp9nBu.js";
import { n as normalizeMatrixAllowList, r as normalizeMatrixUserId, t as resolveMatrixRoomConfig } from "./rooms-b6CJvi29.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-uVqGN8kn.js";
...
import { t as matrixSetupAdapter } from "./setup-core-NB-WCLGi.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-DNr0DfIV.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-D4yRheAh.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CKGobG0N.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
