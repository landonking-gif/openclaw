...
import { f as normalizeVerboseLevel, p as resolveResponseUsageMode } from "./thinking.shared-DCclyaMC.js";
import { r as logVerbose } from "./globals-DhgSPxVV.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-4QR94Oth.js";
import { _ as resolveRunModelFallbacksOverride, v as resolveSessionAgentId } from "./agent-scope-jbts6oCz.js";
import { s as isCliProvider } from "./model-selection-D90MGDui.js";
import { c as loadConfig } from "./io-D4TfzS5d.js";
import "./config-XFKRjuRh.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-ChfElmW5.js";
import { C as resolveGroupSessionKey, d as updateSessionStore, f as updateSessionStoreEntry, i as loadSessionStore } from "./store-Cs-WFRag.js";
import "./sessions-B4aC8Aau.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, r as resolveSessionFilePath } from "./paths-sf4ch2Nw.js";
import { a as resolveFreshSessionTotalTokens } from "./types-COn4K1cd.js";
import { a as isAudioFileName } from "./mime-Dm-Z3ymz.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CKy9ywkv.js";
import { a as stripHeartbeatToken } from "./heartbeat-BsW5WKin.js";
import { u as resolveMemoryFlushPlan } from "./memory-state-DuJSytE1.js";
import { X as buildFallbackNotice, Y as buildFallbackClearedNotice, Z as resolveFallbackTransition, _n as runWithModelFallback, gn as isFallbackSummaryError, h as readPostCompactionContext, m as estimateMessagesTokens, t as runEmbeddedPiAgent, u as compactEmbeddedPiSession, vn as LiveSessionModelSwitchError, wn as queueEmbeddedPiMessage } from "./pi-embedded-DrlfOZ8s.js";
import { a as generateSecureUuid } from "./secure-random-CLpYdCLx.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-DRi9FksF.js";
import { a as scheduleFollowupDrain, n as enqueueFollowupRun, o as refreshQueuedFollowupSession } from "./queue-CfH9Ejk5.js";
...
import { n as resolveSandboxConfigForAgent } from "./config-BktCfJi_.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-CYsuyeRV.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-BnbuS4KL.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DRQRSHRh.js";
import { s as resolveModelAuthMode } from "./model-auth-CRn7ZlFJ.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-Cl2sJ2Ol.js";
...
import { h as resolvePathFromInput, o as parseReplyDirectives, p as resolveEffectiveToolFsWorkspaceOnly } from "./deliver-BR5LDZbK.js";
import { i as isRenderablePayload, n as applyReplyThreading, o as createReplyToModeFilterForChannel, s as resolveReplyToMode, t as applyReplyTagsToPayload } from "./reply-payloads-DAaNk-LV.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CRezfDjg.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-ByTtMp2r.js";
import { a as registerAgentRunContext, n as emitAgentEvent } from "./agent-events-DJAS9OkE.js";
import { _ as readSessionMessages } from "./session-utils-DfebPo3a.js";
import { t as lookupContextTokens } from "./context-DxVhhs9x.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-CW4AjOzF.js";
import { i as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-CNL1wVTj.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CIgbyoMm.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-DK8V8cLO.js";
import { t as createTypingSignaler } from "./typing-mode-B7-Dh6zA.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-Ckn_DEQl.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-ByR5oSig.js";
import { a as resolveModelFallbackOptions, i as isBunFetchSocketError, o as resolveRunAuthProfile, r as formatBunFetchSocketError, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-C43Ew25E.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-Cg58j3ZQ.js";
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-Hc4gkYHF.js");
