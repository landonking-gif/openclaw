import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-DQgqpvCf.js";
...
import { Y as listRiskyConfiguredSafeBins, q as normalizeTrustedSafeBinDirs } from "./io-CHHRUM9X.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BGm3nBEL.js";
import { t as formatCliCommand } from "./command-format-DdT4oLOa.js";
import { a as resolveGatewayAuth } from "./auth-Be2Qu2Lh.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-CyUk4uMr.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-BjVvfs3N.js";
import { n as resolveSandboxConfigForAgent } from "./config-DS0ixI71.js";
import { $ as resolveBrowserConfig, X as redactCdpUrl, et as resolveBrowserControlAuth, rt as resolveProfile } from "./browser-runtime-KakgW5BZ.js";
import "./sandbox-CLjWfBwv.js";
import { N as isInterpreterLikeAllowlistPattern, o as loadExecApprovals } from "./exec-approvals-DhhaUSQB.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-_ZAhQt9K.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-D_J_TZC2.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-pdSb8i3j.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BL1MQFVJ.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DMX5-iiD.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-CPvInm3L.js"),
		import("./probe-auth-B1HQR4n-.js"),
		import("./probe-DQjFf8Se.js")
