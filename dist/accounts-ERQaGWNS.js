...
import { s as resolveMergedAccountConfig } from "./account-helpers-MFn2d_bl.js";
...
import { d as requiresExplicitMatrixDefaultAccount, f as resolveConfiguredMatrixAccountIds, h as getMatrixScopedEnvVarNames, m as resolveMatrixDefaultOrOnlyAccountId } from "./storage-paths-BOnyRjh-.js";
import { a as findMatrixAccountConfig, c as resolveMatrixBaseConfig, s as listNormalizedMatrixAccountIds, t as resolveMatrixConfigFieldPath } from "./config-update-Bf_HzfuK.js";
...
import { t as MatrixClient } from "./sdk-BB8vAK6U.js";
import { n as ensureMatrixSdkLoggingConfigured, o as LogService } from "./logging-DgVz6ZgB.js";
import { i as writeStorageMeta, r as resolveMatrixStoragePaths, t as maybeMigrateLegacyStorage } from "./storage-CgufawAQ.js";
import { n as loadMatrixCredentials, t as credentialsMatchConfig } from "./credentials-read-CM49tDJ7.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-D7via_6x.js"), import("./logging-Ab6hXOmw.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BvCrK5R_.js").then((credentialsReadModule) => ({
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-HnDlhpZZ.js");
