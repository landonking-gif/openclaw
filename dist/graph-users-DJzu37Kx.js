...
import { c as isPrivateIpAddress } from "./ssrf-CyUk4uMr.js";
import { t as createPluginRuntimeStore } from "./runtime-store-DyL9NwDZ.js";
import { i as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist, r as isHttpsUrlAllowedByHostnameSuffixAllowlist } from "./ssrf-policy-DYQzTQgE.js";
...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-CbA0I_N2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-D_uBUeTP.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createNoOpHttpPlugin() {
	await import("./Reflect-MWBT-CZD.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_METADATA_KEY } = await import("./plugin-CvLmGYqm.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_DEPENDENCIES_METADATA_KEY } = await import("./dependency-CmZYaotU.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_EVENTS_METADATA_KEY } = await import("./event-kqQrQz3E.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-BDRSfuSO.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
