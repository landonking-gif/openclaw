...
import { D as clampWithDefault, E as chunkString, j as readEnvInt, w as buildDockerExecArgs } from "./sandbox-BnbuS4KL.js";
import { t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-CzqGD3AZ.js";
import { n as requestHeartbeatNow } from "./heartbeat-wake-Bh4MwMMj.js";
import { n as findPathKey, r as mergePathPrepend } from "./path-prepend-CpVZh1i2.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-CeOmlMJ7.js");
