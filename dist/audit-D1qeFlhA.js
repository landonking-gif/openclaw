...
import { Y as listRiskyConfiguredSafeBins, q as normalizeTrustedSafeBinDirs } from "./io-D4TfzS5d.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BP5T5GjA.js";
import { t as formatCliCommand } from "./command-format-CkCGNdQh.js";
import { a as resolveGatewayAuth } from "./auth-BaMzrXjQ.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-C8Ew-J28.js";
...
import { $ as resolveBrowserConfig, X as redactCdpUrl, et as resolveBrowserControlAuth, rt as resolveProfile } from "./browser-runtime-ZJ4YExWu.js";
import "./sandbox-BnbuS4KL.js";
import { N as isInterpreterLikeAllowlistPattern, o as loadExecApprovals } from "./exec-approvals-CzqGD3AZ.js";
...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-Bhd5nnb9.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-DtHCVsLp.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-TquC5iTN.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-Vm5_HBFV.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-f-d4cal6.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-5zC80xf7.js"),
		import("./probe-auth-fSZowZ9C.js"),
		import("./probe-Uw7hb2rK.js")
