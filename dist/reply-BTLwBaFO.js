...
import { M as applyMergePatch, c as loadConfig } from "./io-CHHRUM9X.js";
...
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-Bk-oI2vE.js";
import { C as resolveGroupSessionKey, b as deriveSessionMetaPatch, d as updateSessionStore, i as loadSessionStore } from "./store-1GMpznZw.js";
import { t as normalizeChatType } from "./chat-type-BjcvDs4y.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-IGaUCqHB.js";
import "./plugins-DyBBeN0u.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-DwnX9NEj.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BC0JJAKv.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-DpBhYgVM.js";
import { a as resolveSessionResetType, i as resolveSessionResetPolicy, n as evaluateSessionFreshness, o as resolveThreadFlag, r as resolveChannelResetConfig, t as resolveAndPersistSessionFile } from "./session-file-IWWLG66-.js";
import { n as resolveSessionKey } from "./session-key-DowUUVMo.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-BuKGzS4T.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-DeETngSc.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BJtjs6Ma.js";
...
import { C as resolveFastModeState, D as getQueueSize, t as resolveQueueSettings, w as clearCommandLane } from "./queue-Dwzpfxpa.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-BRn8izzC.js";
import { r as enqueueSystemEvent } from "./system-events-BpScEji3.js";
import { t as applyOwnerOnlyToolPolicy } from "./tool-policy-DTveRWZi.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BXo8DLd-.js";
import { d as isReasoningTagProvider, n as resolveAgentTimeoutMs, o as disposeSessionMcpRuntime, t as collectTextContentBlocks } from "./content-blocks-D3E1sFJ7.js";
...
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-DanmdyIs.js";
...
import { t as resolveChannelModelOverride } from "./model-overrides-B68fFwFb.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-C81lrxZX.js";
import { t as hasControlCommand } from "./command-detection-B6HG7hjh.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-CByr0Mjy.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-GwkdWp79.js";
import { t as finalizeInboundContext } from "./inbound-context-D5srhWhf.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DNDo43dW.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BxianbEx.js";
import { n as parseInlineDirectives, t as isDirectiveOnly } from "./directive-handling.parse-PYuYfy3l.js";
import { t as resolveCommandAuthorization } from "./command-auth-BlBs2ty0.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-C3xUnUnE.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-B4iN-_Wt.js";
import { t as buildCommandContext } from "./commands-context-hEcfj4dT.js";
import { t as extractExplicitGroupId } from "./group-id-BEbjZZVu.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-D_DEHHTj.js";
import { n as resolveContextTokens, t as createModelSelectionState } from "./model-selection-UW5djlO6.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-DrRUJbXm.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-BdJYnve8.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CaUzsVlp.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-CH3e7BMz.js";
import { n as resolveTypingMode } from "./typing-mode-xt7yRSLt.js";
import { i as resolveConversationBindingContextFromMessage, o as resolveEffectiveResetTargetSessionKey } from "./conversation-binding-input-D-P7xfAD.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-BJydiKUZ.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-CdKrEiMa.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-CvTloRiD.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-2YCrkaAO.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-FbFyNldO.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-YiRemNJ1.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-DBfG8hgX.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-DVr77XMi.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-DVr77XMi.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		skillFilter
	}) : [];
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-DVYG3fom.js");
	...
	if (!isAbortRequestText(command.rawBodyNormalized) && sessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-xGMMZjcL.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-CRrQudZU.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-CRrQudZU.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-Yjykvntd.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-G9A7UWyh.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-BYoj2lSj.js");
	return agentRunnerRuntimePromise;
}
function loadRouteReplyRuntime() {
	routeReplyRuntimePromise ??= import("./route-reply.runtime-C1LGfsDV.js");
	return routeReplyRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-CB-Agdak.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-Yjykvntd.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-DQP4W7ZJ.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-B7v7TAPf.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-H3bhTSEc.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BmtFOBft.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-BQ_2VbH1.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-BKjhsTeZ.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-CS8lwO-O.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-CdGTVVm-.js");
