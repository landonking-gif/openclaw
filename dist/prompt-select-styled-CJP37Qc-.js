...
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-ozuUQtXc.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-CTbjH_aB.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-RS5GiWu3.js";
...
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-Dj6njjfb.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-DQgqpvCf.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-DuSPmmWB.js";
import { T as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-4QR94Oth.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-jbts6oCz.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-NliLe8k-.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-BUc4RCkE.js";
import { _ as resolveHooksGmailModel, a as getModelRefStatus, h as resolveConfiguredModelRef } from "./model-selection-D90MGDui.js";
import { Ft as resolveNormalizedProviderModelMaxTokens, G as isTrustedSafeBinPath, It as LEGACY_TALK_PROVIDER_ID, N as migrateLegacyConfig, Rt as normalizeTalkSection, W as getTrustedSafeBinDirs, Y as listRiskyConfiguredSafeBins, dt as resolveCommandResolutionFromArgv, f as readConfigFileSnapshot, q as normalizeTrustedSafeBinDirs, x as writeConfigFile } from "./io-CHHRUM9X.js";
import { C as resolveTelegramPreviewStreamMode, S as resolveSlackStreamingMode, _ as formatSlackStreamModeMigrationMessage, b as resolveDiscordPreviewStreamMode, v as formatSlackStreamingBooleanMigrationMessage, x as resolveSlackNativeStreaming } from "./zod-schema.providers-core-D0wGIf0e.js";
import { r as normalizeChatChannelId } from "./chat-meta-vnJDD9J6.js";
import "./registry-C0lW5OhB.js";
import { a as normalizePluginsConfig, i as normalizePluginId, o as resolveEffectiveEnableState } from "./config-state-BDUjFaED.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-BfpGjG9q.js";
import "./config-B3X9mknZ.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools-B7RdthJa.js";
import { t as describeUnknownError } from "./shared-Cla-EFiW.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-BfrrjpsB.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-C_Dez-ew.js";
import { t as formatCliCommand } from "./command-format-DdT4oLOa.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-qlIzMva2.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-xeTiU5Rk.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-DJ9vJ5GW.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CI1Fmm6N.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-qNa-BMKA.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-CTrWm98z.js";
import { a as readGatewayTokenEnv } from "./credential-planner-D2hepxEM.js";
...
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-DWRsZZen.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./registry-IGaUCqHB.js";
import "./plugins-DyBBeN0u.js";
import { i as resolveMainSessionKey } from "./main-session-DwnX9NEj.js";
import { i as resolveAgentSessionDirs } from "./sessions-BHlzEkJZ.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BC0JJAKv.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-K3E4OVw3.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-CQ6GbRMT.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-zb9A_l2V.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-BtIQ7hA1.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-B3mqSLaq.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-IreFRnZR.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DuUYKVoI.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DcgU3_4R.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DIngRSi2.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-aadA2H0l.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-TTLn5Hhj.js";
...
import { n as formatConfigIssueLines } from "./issue-format-CJ9Q2b0V.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-BxDqTsB2.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-kOkOEUFt.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DucN9nUv.js";
import { r as listPotentialConfiguredChannelIds } from "./config-presence-BjVvfs3N.js";
import { a as readChannelAllowFromStore } from "./pairing-store-F3aj-zSw.js";
...
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-DS0ixI71.js";
import { Y as readBrowserVersion, nt as resolveGoogleChromeExecutableForPlatform, q as parseBrowserMajorVersion } from "./browser-runtime-KakgW5BZ.js";
import "./sandbox-CLjWfBwv.js";
import { o as resolveApiKeyForProvider } from "./model-auth-BuOtp6JF.js";
import { b as resolveBootstrapContextForRun, g as TrimmedNonEmptyStringFieldSchema, m as LowercaseNonEmptyStringFieldSchema, n as buildBootstrapInjectionStats, p as DeliveryThreadIdFieldSchema, s as inferLegacyName, t as analyzeBootstrapBudget, u as normalizeOptionalText, v as parseOptionalField } from "./bootstrap-budget-H6YjbJqO.js";
import { H as resolveBootstrapMaxChars, W as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-0c94i8Rl.js";
import { t as migrateLegacyWebSearchConfig } from "./legacy-web-search-D3XxNwvu.js";
import { b as resolveExecApprovalsFromFile, l as minSecurity, o as loadExecApprovals, s as maxAsk } from "./exec-approvals-DhhaUSQB.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-D4zFHAus.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BbG4WK4I.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-Br-hLfNQ.js";
import { i as listRouteBindings } from "./bindings-C5OFSzH-.js";
import { r as resolveActiveMemoryBackendConfig } from "./memory-runtime-B7bIJxpo.js";
import { t as resolveMemorySearchConfig } from "./memory-search-weSJLcII.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-aHGI_5_V.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-DGVIISSQ.js";
import { n as logConfigUpdated } from "./logging-BAEiWu9t.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-BW4u1jDh.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-Dd3DMhTT.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-DulFLbDc.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CnvBuP1H.js";
import { i as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-C7QlAbe4.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-Ca6u1eOA.js";
import { _ as DEFAULT_GOOGLE_API_BASE_URL } from "./memory-core-host-engine-embeddings-CURmoLEe.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-DUznqxbG.js";
import { t as checkQmdBinaryAvailability } from "./memory-core-host-engine-qmd-COTQu-NT.js";
import "./memory-core-host-engine-storage-Dlg-rajS.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B3zPBDLA.js";
import { a as buildPluginStatusReport, r as buildPluginCompatibilityWarnings } from "./status-hWFg4vkq.js";
import { t as note$1 } from "./note-DtFCCVBg.js";
import { r as healthCommand } from "./health-OBFGtw_J.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-KnnXJJtX.js";
import { g as coerceFiniteScheduleNumber, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-CHgSB07s.js";
import { i as normalizeTelegramAllowFromEntry, n as isNumericTelegramUserId, r as listTelegramAccountIds, t as inspectTelegramAccount } from "./read-only-account-inspect.telegram-FjNkUdsF.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-agzaljVD.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-DlibnJR5.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-nP1k4AcJ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B4JzLGgx.js";
import { t as formatHealthCheckFailure } from "./health-format-QaHnQLvi.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-Du85ScIY.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-mvtKADgm.js";
import { n as doctorShellCompletion } from "./doctor-completion-Cx9ByWtD.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DnjmkugJ.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-1omRQTVz.js";
import "./doctor-state-migrations-CgUxFvG5.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-CZ5b3twO.js";
...
function scanConfiguredChannelPluginBlockers(cfg, env = process.env) {
	...
	for (const plugin of registry.plugins) {
		...
		if (enableState.enabled || !enableState.reason || enableState.reason !== "disabled in config" && enableState.reason !== "plugins disabled") continue;
...
function resolveHostExecPolicy(params) {
	...
	const agentEntry = params.agentId && params.approvals.agents && params.approvals.agents[params.agentId] ? params.approvals.agents[params.agentId] : void 0;
	...
	return {
		security: minSecurity(configuredSecurity, resolved.agent.security),
		ask: resolved.agent.ask === "off" ? "off" : maxAsk(configuredAsk, resolved.agent.ask),
		securitySource: agentEntry?.security ? `${basePath} agents.${params.agentId}.security` : defaults?.security ? `${basePath} defaults.security` : "caller tool policy fallback",
		askSource: agentEntry?.ask ? `${basePath} agents.${params.agentId}.ask` : defaults?.ask ? `${basePath} defaults.ask` : "caller tool policy fallback"
	};
}
function collectExecPolicyConflictWarnings(cfg) {
	...
	const maybeWarn = (params) => {
		...
		if (!execConfig || !execConfig.security && !execConfig.ask) return;
		const host = resolveHostExecPolicy({
			approvals,
			execConfig,
			agentId: params.agentId
		});
		const securityConflict = execConfig.security !== void 0 && execSecurityRank(execConfig.security) > execSecurityRank(host.security);
		const askConflict = execConfig.ask !== void 0 && execAskRank(execConfig.ask) < execAskRank(host.ask);
		if (!securityConflict && !askConflict) return;
		const configParts = [];
		const hostParts = [];
		if (execConfig.security !== void 0) {
			configParts.push(`security="${execConfig.security}"`);
			hostParts.push(`${host.securitySource}="${host.security}"`);
		}
		if (execConfig.ask !== void 0) {
