...
import { M as applyMergePatch, nn as resolveOwnerDisplaySetting } from "./io-D4TfzS5d.js";
...
import { n as sanitizeImageBlocks } from "./tool-images-DPgnL_CS.js";
import { i as resolveHeartbeatPrompt } from "./heartbeat-BsW5WKin.js";
import { r as loadEnabledBundleMcpConfig, t as extractMcpServerMap } from "./bundle-mcp-PL6Xzry3.js";
import { Xn as resolveOpenClawDocsPath, a as buildSystemPromptReport, c as redactRunIdentifier, l as resolveRunWorkspaceDir, n as detectImageReferences, o as buildSystemPromptParams, p as buildAgentSystemPrompt, r as loadImageFromRef } from "./pi-embedded-DrlfOZ8s.js";
import { r as enqueueSystemEvent } from "./system-events-Dm76CSl1.js";
import { v as buildModelAliasLines } from "./directives-CSH_Jwnn.js";
import { n as buildTtsSystemPromptHint } from "./tts-BBj3m1Oi.js";
import { a as prependBootstrapPromptWarning, b as resolveBootstrapContextForRun, i as buildBootstrapTruncationReportMeta, n as buildBootstrapInjectionStats, r as buildBootstrapPromptWarning, t as analyzeBootstrapBudget, y as makeBootstrapWarn } from "./bootstrap-budget-Cl2sJ2Ol.js";
import { D as isFailoverErrorMessage, H as resolveBootstrapMaxChars, U as resolveBootstrapPromptTruncationWarningMode, W as resolveBootstrapTotalMaxChars, h as classifyFailoverReason } from "./pi-embedded-helpers-D-NRJ7pw.js";
import { _ as getProcessSupervisor, v as detectRuntimeShell } from "./model-runtime-BMpWyUay.js";
import { n as requestHeartbeatNow } from "./heartbeat-wake-Bh4MwMMj.js";
import { s as resolveFailoverStatus, t as FailoverError } from "./failover-error-Bt0YiRUD.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CtCPziVL.js";
import { n as CLI_RESUME_WATCHDOG_DEFAULTS, r as CLI_WATCHDOG_MIN_TIMEOUT_MS, t as CLI_FRESH_WATCHDOG_DEFAULTS } from "./cli-watchdog-defaults-roNWI7Z6.js";
