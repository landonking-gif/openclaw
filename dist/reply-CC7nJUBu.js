...
import { T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-4QR94Oth.js";
import { r as normalizeStringEntries, t as normalizeAtHashSlug } from "./string-normalization-CmGlAIu6.js";
import { a as resolveAgentDir, f as resolveAgentSkillsFilter, i as resolveAgentConfig, n as listAgentEntries, p as resolveAgentWorkspaceDir, v as resolveSessionAgentId } from "./agent-scope-jbts6oCz.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-BUc4RCkE.js";
import { v as resolveModelRefFromString } from "./model-selection-D90MGDui.js";
import { M as applyMergePatch, c as loadConfig } from "./io-D4TfzS5d.js";
...
import { d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-ChfElmW5.js";
import { C as resolveGroupSessionKey, b as deriveSessionMetaPatch, d as updateSessionStore, i as loadSessionStore } from "./store-Cs-WFRag.js";
import { t as normalizeChatType } from "./chat-type-CPCFLfx7.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-DWiJhWZh.js";
import "./plugins-B9ydw93g.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BBpmPNJV.js";
import { a as resolveSessionTranscriptPath, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-sf4ch2Nw.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-COn4K1cd.js";
import { a as resolveSessionResetType, i as resolveSessionResetPolicy, n as evaluateSessionFreshness, o as resolveThreadFlag, r as resolveChannelResetConfig, t as resolveAndPersistSessionFile } from "./session-file-BeBZgEyB.js";
import { n as resolveSessionKey } from "./session-key-C2EnQbn1.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-DsaGJATs.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-CKy9ywkv.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DUzSUs1P.js";
...
import { C as resolveFastModeState, D as getQueueSize, t as resolveQueueSettings, w as clearCommandLane } from "./queue-CfH9Ejk5.js";
...
import { t as applyOwnerOnlyToolPolicy } from "./tool-policy-CFs2Ksh2.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DRQRSHRh.js";
import { d as isReasoningTagProvider, n as resolveAgentTimeoutMs, o as disposeSessionMcpRuntime, t as collectTextContentBlocks } from "./content-blocks-tjcQEIr2.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-Ct5indmW.js";
import { i as supportsXHighThinking } from "./thinking-DVCoUhWZ.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-xvYxmWU7.js";
import { t as buildOutboundSessionContext } from "./session-context-CgDKT3SR.js";
import { t as normalizeGroupActivation } from "./group-activation-BNrkNDfU.js";
import { t as resolveChannelModelOverride } from "./model-overrides-d4U3tOAz.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Vi5GuGdN.js";
...
import { t as normalizeInboundTextNewlines } from "./inbound-text-CHJsRyD7.js";
import { t as finalizeInboundContext } from "./inbound-context-DRnxt8Yi.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-C6ShMImc.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-CKo0BqYA.js";
import { n as parseInlineDirectives, t as isDirectiveOnly } from "./directive-handling.parse-De_TbK6w.js";
import { t as resolveCommandAuthorization } from "./command-auth-DSVGUFnX.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-Be-K0trL.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CIgbyoMm.js";
import { t as buildCommandContext } from "./commands-context-DLLPQSwr.js";
import { t as extractExplicitGroupId } from "./group-id-cwEdRoEd.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CXI3tUrS.js";
import { n as resolveContextTokens, t as createModelSelectionState } from "./model-selection-BdnCicBy.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BD0TPa1C.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-DVJ2jJx4.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-DK8V8cLO.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-DYstuH03.js";
import { n as resolveTypingMode } from "./typing-mode-B7-Dh6zA.js";
import { i as resolveConversationBindingContextFromMessage, o as resolveEffectiveResetTargetSessionKey } from "./conversation-binding-input-M-vpzhe5.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-Dug5uBN3.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-Ch2n5GWD.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-DXlbOwN7.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-l_SjtPTM.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-CCSaRx2N.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-mWknwXdi.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-ClTsFDdI.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-0Ixf1v4b.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-0Ixf1v4b.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		skillFilter
	}) : [];
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-CSC7z-ja.js");
	...
	if (!isAbortRequestText(command.rawBodyNormalized) && sessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-DyquYVgt.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-1gxDFgV8.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-1gxDFgV8.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-41ccP-sQ.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-DbObpXTL.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-B8BEiPlS.js");
...
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-Db4Km_oG.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-41ccP-sQ.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-CNOfM5Gk.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-XaXFbKkq.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-DvWaq7OG.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-oW_fvqlU.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-BahCAr1P.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-B2lbd7fW.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-CZDUkE8m.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-fDXQBaW9.js");
