import { d as resolveThreadSessionKeys, u as resolveAgentIdFromSessionKey } from "./session-key-4QR94Oth.js";
...
import { i as resolveConfiguredAcpBindingRecord, t as ensureConfiguredAcpBindingReady } from "./persistent-bindings.lifecycle-CKnq43S7.js";
...
import { a as resolveMatrixAccountConfig, c as resolveSharedMatrixClient, d as resolveMatrixAuthContext, i as resolveMatrixAccount, m as isBunRuntime, n as resolveConfiguredMatrixBotUserIds, s as releaseSharedClientInstance, u as resolveMatrixAuth } from "./accounts-ERQaGWNS.js";
import "./runtime-api-D7PTL6Yn.js";
import { t as getMatrixRuntime } from "./runtime-BHaBGlM4.js";
import { i as createAsyncLock, r as isMatrixNotFoundError } from "./sdk-BB8vAK6U.js";
import { o as LogService } from "./logging-DgVz6ZgB.js";
import { n as resolveMatrixStateFilePath } from "./storage-CgufawAQ.js";
import { i as resolveMatrixAllowListMatch, n as normalizeMatrixAllowList, r as normalizeMatrixUserId, t as resolveMatrixRoomConfig } from "./rooms-Cx9ibB7B.js";
import { t as resolveMatrixTargets } from "./resolve-targets-D7GJ9KpQ.js";
import { _ as isPollEventType, a as sendMessageMatrix, b as parsePollStartContent, c as sendSingleTextMessageMatrix, f as setActiveMatrixClient, h as formatPollAsText, i as reactMatrixMessage, l as sendTypingMatrix, n as editMessageMatrix, r as prepareMatrixSingleText, s as sendReadReceiptMatrix, t as chunkMatrixText, v as isPollStartType } from "./send-CPOUK7ub.js";
import { f as extractMatrixReactionAnnotation, l as MATRIX_REACTION_EVENT_TYPE, r as promoteMatrixDirectRoomCandidate } from "./direct-management-6KAWaf1I.js";
import { o as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-K0UqOpw2.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-BKrPfh_x.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-xKPjRxdv.js";
import { a as formatMatrixMessageText, i as formatMatrixMediaUnavailableText, n as fetchMatrixPollSnapshot, o as resolveMatrixMessageAttachment, s as resolveMatrixMessageBody } from "./poll-summary-BZ3rFzKY.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-DY67m1-w.js"), import("./direct-room-BsRxvEVN.js")]).then(([directManagementModule, directRoomModule]) => ({
...
function createMatrixRoomMessageHandler(params) {
	...
	return async (roomId, event) => {
		...
		try {
			...
			const draftStream = streamingEnabled ? createMatrixDraftStream({
				roomId,
				client,
				cfg,
					...
					try {
						return await core.channel.reply.dispatchReplyFromConfig({
							...
							replyOptions: {
								...
								disableBlockStreaming: streamingEnabled ? true : void 0,
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-C2uQ2VV2.js"),
		import("./device-health-DdPmA3UU.js"),
		import("./profile-C1Alqkxe.js"),
		import("./legacy-crypto-restore-Blm8gzif.js"),
		import("./startup-verification-DzyrBr0q.js")
