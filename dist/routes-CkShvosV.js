...
import { o as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-DAQ-cH3_.js";
...
import { n as deriveDefaultBrowserCdpPortRange, r as deriveDefaultBrowserControlPort } from "./port-defaults-D49o7YS2.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-DQDdIFNb.js";
import "./temp-path-DX-pv_Uq.js";
import { a as ensureGatewayStartupAuth } from "./nodes.helpers-CvcvP3zG.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Mkvf2plp.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-Mkvf2plp.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-Mkvf2plp.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
