...
import { _ as normalizeAccountId, l as normalizeMainKey } from "./session-key-4QR94Oth.js";
import { r as normalizeStringEntries } from "./string-normalization-CmGlAIu6.js";
import { n as logError } from "./logger-BGSZ8m40.js";
import { c as loadConfig, x as writeConfigFile } from "./io-CHHRUM9X.js";
import { S as resolveSlackStreamingMode, x as resolveSlackNativeStreaming, y as mapStreamingModeToSlackLegacyDraftStreamMode } from "./zod-schema.providers-core-D0wGIf0e.js";
import { u as updateLastRoute } from "./store-1GMpznZw.js";
...
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-Dl-S3AjE.js";
import { _ as resolveChannelConfigWrites } from "./channel-config-helpers-XkwmfU3s.js";
import { m as dispatchPluginInteractiveHandler } from "./types-CNVNmBVr.js";
import { t as pruneMapToMaxSize } from "./map-size-I6aqbqp7.js";
...
import { c as getExecApprovalApproverDmNoticeText, t as buildApprovalInteractiveReply } from "./exec-approval-reply-Dh5fPINs.js";
import "./core-BD-JWpum.js";
import "./routing-C41nSjtW.js";
import "./secret-input-BQYGV6z8.js";
import { o as createReplyDispatcherWithTyping, t as dispatchInboundMessage } from "./dispatch-CIeVo87K.js";
...
import { a as patchAllowlistUsersInConfigEntries, i as mergeAllowlist, n as buildAllowlistResolutionSummary, o as summarizeMapping, t as addAllowlistUserEntriesFromConfigEntry } from "./resolve-utils-D29Olqfd.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist } from "./dm-policy-shared-DGVIISSQ.js";
import { s as clearHistoryEntriesIfEnabled } from "./history-CYQfJBwi.js";
import "./reply-history-DaHn-Tkh.js";
import { o as resolveExecApprovalCommandDisplay } from "./exec-approval-session-target-B-Xxpasz.js";
...
import "./webhook-request-guards-CdEpsABJ.js";
...
import { a as createStatusReactionController, r as DEFAULT_TIMING } from "./channel-feedback-CRh-gYDv.js";
import { n as shouldDebounceTextInbound, t as createChannelInboundDebouncer } from "./channel-inbound-CFiZXQsp.js";
import { c as createDraftStreamLoop } from "./channel-lifecycle-C-w8XWq8.js";
import { _ as resolveSlackAppToken, a as resolveSlackWebClientOptions, h as resolveSlackAccount, v as resolveSlackBotToken } from "./runtime-api-DWbJQ1j1.js";
import { F as shouldHandleSlackExecApprovalRequest, M as slackNativeApprovalAdapter, N as getSlackExecApprovalApprovers, P as normalizeSlackApproverId, S as reactSlackMessage, T as removeSlackReaction, a as normalizeAllowList, g as editSlackMessage, l as resolveSlackAllowListMatch, m as deleteSlackMessage, p as recordSlackThreadParticipation, s as normalizeSlackAllowOwnerEntry, u as resolveSlackUserAllowed } from "./probe-UUq7Renx.js";
import { a as truncateSlackText, l as normalizeSlackOutboundText, o as sendMessageSlack, p as buildSlackBlocksFallbackText, s as SLACK_TEXT_LIMIT, t as resolveSlackReplyBlocks } from "./reply-blocks-8x28WweT.js";
...
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-BfPjE57h.js";
...
function buildSlackPendingApprovalBlocks(request) {
	...
	const interactiveBlocks = resolveSlackReplyBlocks({
		text: "",
		interactive: buildApprovalInteractiveReply({ approvalId: request.id })
	}) ?? [];
	return [
		{
			type: "section",
...
var SlackExecApprovalHandler = class {
	constructor(opts) {
		...
		this.runtime = createExecApprovalChannelRuntime({
			...
			isConfigured: () => Boolean(opts.config.enabled && getSlackExecApprovalApprovers({
				cfg: opts.cfg,
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-C1IChJTz.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-Bd3nuLfd.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-C_6_KoVY.js");
...
async function monitorSlackProvider(opts = {}) {
	...
	const execApprovalsHandler = slackCfg.execApprovals?.enabled ? new SlackExecApprovalHandler({
		app,
		accountId: account.accountId,
