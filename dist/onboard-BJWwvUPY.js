...
import { f as readConfigFileSnapshot } from "./io-CHHRUM9X.js";
...
import "./daemon-runtime-CI1Fmm6N.js";
import { c as normalizeGatewayTokenInput, d as randomToken, f as resolveControlUiLinks, g as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-IreFRnZR.js";
...
import { t as runSetupWizard } from "./setup-Cb7bx4d2.js";
import { a as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-MDBmvl3r.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-p8mUXAgD.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BqNC_Gbh.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CSSt0qFC.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BoxqABcF.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BbVZPZII.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-B5JUvotp.js");
