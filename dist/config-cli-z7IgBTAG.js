...
import { I as validateConfigObjectRaw, P as collectUnsupportedSecretRefPolicyIssues, f as readConfigFileSnapshot } from "./io-CHHRUM9X.js";
import { r as replaceConfigFile } from "./config-B3X9mknZ.js";
import { a as resolveSecretRefValue } from "./resolve-CSarITi2.js";
import { t as formatCliCommand } from "./command-format-DdT4oLOa.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CJ9Q2b0V.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-CuJLIQ4X.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BtgeUTz4.js";
import { n as setCommandJsonMode } from "./json-mode-DTQUpr80.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-Dq36Luno.js");
